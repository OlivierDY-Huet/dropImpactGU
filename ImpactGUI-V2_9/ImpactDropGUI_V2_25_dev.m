...
S.W_V2=uix.Panel('Parent',S.W_V);
        ...
        S.W_V2_H2=uix.Panel('Title','ANALYSIS','Parent',S.W_V2_H);
            ...
            S.W_V2_H2_V3=uix.Panel('Title','Analysis settings','Parent',S.W_V2_H2_V);
                ...
                S.W_V2_H2_V3_T5=uix.Panel('Title','Binarisation','Parent',S.W_V2_H2_V3_T);
                S.W_V2_H2_V3_T6=uix.Panel('Title','Contact angle','Parent',S.W_V2_H2_V3_T);
                S.W_V2_H2_V3_T7=uix.Panel('Title','Underneath','Parent',S.W_V2_H2_V3_T);   
                S.W_V2_H2_V3_T.TabTitles={'lvl 1','lvl 2','lvl 3','lvl 4','lvl 5','lvl 7A','lvl 7B'};
...
uicontrol('Style','text','HorizontalAlignment','left','String','Threshold liq./air','Parent',S.W_V2_H2_V3_T5_G); %--
uicontrol('Style','text','HorizontalAlignment','left','String','Minimum detection','Parent',S.W_V2_H2_V3_T5_G);
uicontrol('Style','text','HorizontalAlignment','left','String','Surface correction','Parent',S.W_V2_H2_V3_T5_G);
S.W_V2_H2_V3_T5_G_edit(1)=uicontrol('Style','edit','String','0','Parent',S.W_V2_H2_V3_T5_G); %--
S.W_V2_H2_V3_T5_G_edit(2)=uicontrol('Style','edit','String','0','Parent',S.W_V2_H2_V3_T5_G);
S.W_V2_H2_V3_T5_G_edit(3)=uicontrol('Style','edit','String','0','Parent',S.W_V2_H2_V3_T5_G);
S.W_V2_H2_V3_T5_G_edit(4)=uicontrol('Style','edit','String','0','Parent',S.W_V2_H2_V3_T5_G); %--
set(S.W_V2_H2_V3_T5_G_edit(4),'Enable','off')
S.W_V2_H2_V3_T5_G_edit(5)=uicontrol('Style','edit','String','0','Parent',S.W_V2_H2_V3_T5_G);
set(S.W_V2_H2_V3_T5_G_edit(5),'Enable','off')
uix.Empty('Parent',S.W_V2_H2_V3_T5_G)
uicontrol('Style','text','HorizontalAlignment','left','String','[uint8]','Parent',S.W_V2_H2_V3_T5_G); %--
uicontrol('Style','text','HorizontalAlignment','left','String','[px]','Parent',S.W_V2_H2_V3_T5_G);
uicontrol('Style','text','HorizontalAlignment','left','String','[px]','Parent',S.W_V2_H2_V3_T5_G);
S.W_V2_H2_V3_T5_G_check(1)=uicontrol('Style','checkbox','String','Fill above surface','value',1,'Parent',S.W_V2_H2_V3_T5_G); %--
S.W_V2_H2_V3_T5_G_check(2)=uicontrol('Style','checkbox','String','Fill on surface','value',1,'Parent',S.W_V2_H2_V3_T5_G);
S.W_V2_H2_V3_T5_G_push=uicontrol('Style','pushbutton','String','Default','Parent',S.W_V2_H2_V3_T5_G);
set(S.W_V2_H2_V3_T5_G,'Widths',[-2 -1 -1 -0.5 -2],'Heights',[-1 -1 -1]);
...
uicontrol('Style','text','HorizontalAlignment','left','String','Method','Parent',S.W_V2_H2_V3_T6_G);  %--
uicontrol('Style','text','HorizontalAlignment','left','String','Zone','Parent',S.W_V2_H2_V3_T6_G);
uix.Empty('Parent',S.W_V2_H2_V3_T6_G)
S.W_V2_H2_V3_T6_G_pop=uicontrol('Style','pop','HorizontalAlignment','left','String',{'None','Poly2-Auto','Poly2','Spline','Gradient'},'value',1,'Parent',S.W_V2_H2_V3_T6_G); %--
...
uix.Empty('Parent',S.W_V2_H2_V3_T6_G)
uicontrol('Style','text','HorizontalAlignment','left','String','Offset','Parent',S.W_V2_H2_V3_T6_G);  %--
uicontrol('Style','text','HorizontalAlignment','left','String','Smooth','Parent',S.W_V2_H2_V3_T6_G);
uicontrol('Style','text','HorizontalAlignment','left','String','Weight','Parent',S.W_V2_H2_V3_T6_G);
...
S.W_V2_H2_V3_T6_G_edit(4)=uicontrol('Style','edit','String','0','Parent',S.W_V2_H2_V3_T6_G);
uicontrol('Style','text','HorizontalAlignment','left','String','[px]','Parent',S.W_V2_H2_V3_T6_G);  %--
uicontrol('Style','text','HorizontalAlignment','left','String','(0-1)','Parent',S.W_V2_H2_V3_T6_G);  %--
uix.Empty('Parent',S.W_V2_H2_V3_T6_G)

set(S.W_V2_H2_V3_T6_G,'Widths',[-1 -1 -0.5 -1 -1 -0.5],'Heights',[-1 -1 -1]);   

%--------------------------------------------------------------------------
% Analysis settings, tab: lvl 7B: Under

S.W_V2_H2_V3_T7_G=uix.Grid('Parent',S.W_V2_H2_V3_T7);

S.W_V2_H2_V3_T7_G_check=uicontrol('Style','checkbox','String','Complete under','value',1,'Parent',S.W_V2_H2_V3_T7_G);%--
set(S.W_V2_H2_V3_T7_G_check,'Enable','off')
...
set(S.W_V2_H2_V3_T7_G,'Widths',[-2 -1 -3],'Heights',[-1 -1 -1]); 
...
set([S.W_V2_H2_V3_T5_G_edit(:);S.W_V2_H2_V3_T5_G_check(:);S.W_V2_H2_V3_T5_G_push],'Call',{@W_V2_H2_V3_T5_G_sharedCall,S});

%--------------------------------------------------------------------------
% Analysis settings, tab: lvl 7: CA + underneath
set([S.W_V2_H2_V3_T6_G_pop;S.W_V2_H2_V3_T6_G_edit(:);S.W_V2_H2_V3_T6_G_push],'Call',{@W_V2_H2_V3_T6_G_sharedCall,S}) % Shared Callback
set([S.W_V2_H2_V3_T7_G_edit;S.W_V2_H2_V3_T7_G_check],'Call',{@W_V2_H2_V3_T7_G_sharedCall,S}) % Shared Callback
...
%             end
        ...
        for k=1:I.file.tab.full.Lvl{dataNum}
            switch k
                ...
                case 5
                    set(S.W_V2_H2_V3_T5_G_edit(1),'string',I.file.tab.full.Setting{dataNum}.binarisation.threshold)
                    set(S.W_V2_H2_V3_T5_G_edit(2),'string',I.file.tab.full.Setting{dataNum}.binarisation.minDetection)
                    set(S.W_V2_H2_V3_T5_G_edit(3),'string',I.file.tab.full.Setting{dataNum}.binarisation.surfCorrection)
                    set(S.W_V2_H2_V3_T5_G_check(1),'value',I.file.tab.full.Setting{dataNum}.binarisation.fill(1))
                    set(S.W_V2_H2_V3_T5_G_check(2),'value',I.file.tab.full.Setting{dataNum}.binarisation.fill(2))
                case 6
                ...
                case 7
                    P=get(S.W_V2_H2_V3_T6_G_pop,'String');
                    set(S.W_V2_H2_V3_T6_G_pop,'value',find(strcmp(I.file.tab.full.Setting{dataNum}.contactAngle.method,P)==1))
                    set(S.W_V2_H2_V3_T6_G_edit(1),'string',I.file.tab.full.Setting{dataNum}.contactAngle.zone)
                    set(S.W_V2_H2_V3_T6_G_edit(2),'string',I.file.tab.full.Setting{dataNum}.contactAngle.offset)
                    set(S.W_V2_H2_V3_T6_G_edit(3),'string',I.file.tab.full.Setting{dataNum}.contactAngle.smoothVal)
                    set(S.W_V2_H2_V3_T6_G_edit(4),'string',I.file.tab.full.Setting{dataNum}.contactAngle.Weight)
                case 8
                    I.track.mod=I.file.tab.full.Setting{dataNum}.trackingMod;
                case 9
...
switch h  % Who called?
    case S.W_V2_H1_V2_V5_H_pop
        if get(h,'value')==1
            ...
            set(S.W_V2_H2_V3_T5_G_edit(4),'Enable','on')
            set(S.W_V2_H2_V3_T5_G_edit(5),'Enable','on')
            set(S.W_V2_H2_V3_T7_G_check,'Enable','on')
...
function []=W_V2_H2_V3_T5_G_sharedCall(varargin) %Manage the binarisation
[h,S]=varargin{[1,3]};  % Get calling handle and structure
switch h
    case {S.W_V2_H2_V3_T5_G_edit(1),S.W_V2_H2_V3_T5_G_edit(4)}
        set(h,'string',uint8(str2double(get(h,'string'))))
    case {S.W_V2_H2_V3_T5_G_edit(2),S.W_V2_H2_V3_T5_G_edit(3),S.W_V2_H2_V3_T5_G_edit(5)}
        set(h,'string',abs(round(str2double(get(h,'string')))))
    case S.W_V2_H2_V3_T7_G_edit
        if get(h,'string')<0 
             set(h,'string',0)
        end
    case S.W_V2_H2_V3_T5_G_check(1)
        if get(h,'value')==0
            set(S.W_V2_H2_V3_T5_G_check(2),'value',0)
        end
    case S.W_V2_H2_V3_T5_G_check(2)
        if get(h,'value')==1
            set(S.W_V2_H2_V3_T5_G_check(1),'value',1)
        end    
...
function []=W_V2_H2_V3_T6_G_sharedCall(varargin) %Manage the contact angle options
[h,S]=varargin{[1,3]};  % Get calling handle and structure
switch h
    case S.W_V2_H2_V3_T6_G_pop
        switch get(h,'value')
            case 1
                set(S.W_V2_H2_V3_T6_G_edit(1),'visible','off')
                set(S.W_V2_H2_V3_T6_G_edit(2),'visible','off')
                set(S.W_V2_H2_V3_T6_G_edit(3),'visible','off')
                set(S.W_V2_H2_V3_T6_G_edit(4),'visible','off')
            case 2
                set(S.W_V2_H2_V3_T6_G_edit(1),'visible','on')
                set(S.W_V2_H2_V3_T6_G_edit(2),'enable','on')
                set(S.W_V2_H2_V3_T6_G_edit(3),'enable','on')
                set(S.W_V2_H2_V3_T6_G_edit(4),'enable','on')
            case 3
                set(S.W_V2_H2_V3_T6_G_edit(1),'visible','on')
                set(S.W_V2_H2_V3_T6_G_edit(2),'enable','on')
                set(S.W_V2_H2_V3_T6_G_edit(3),'enable','off')
                set(S.W_V2_H2_V3_T6_G_edit(4),'enable','on')
            case 4
                set(S.W_V2_H2_V3_T6_G_edit(1),'visible','on')
                set(S.W_V2_H2_V3_T6_G_edit(2),'enable','on')
                set(S.W_V2_H2_V3_T6_G_edit(3),'enable','on')
                set(S.W_V2_H2_V3_T6_G_edit(4),'enable','off')
            case 5
                set(S.W_V2_H2_V3_T6_G_edit(1),'visible','on')
                set(S.W_V2_H2_V3_T6_G_edit(2),'visible','off')
                set(S.W_V2_H2_V3_T6_G_edit(3),'visible','off')
...
I=get(S.W_V1,'UserData');
[I.obs.mainDrop]=getContactAngle(I.obs.mainDrop,I.img.type.S{1},I.img.type.E,str2double(get(S.W_V2_H2_V3_T6_G_edit(1),'string')),...
    get(S.W_V2_H2_V3_T6_G_pop,'val'),str2double(get(S.W_V2_H2_V3_T5_G_edit(1),'string')),...
    str2double(get(S.W_V2_H2_V3_T6_G_edit(2),'string')),str2double(get(S.W_V2_H2_V3_T6_G_edit(3),'string')),str2double(get(S.W_V2_H2_V3_T6_G_edit(4),'string')));
[I.img.features.positions{'contactAngle'}]=getAng2draw(I.obs.mainDrop,I.img.type.B,I.img.features.shape{'contactAngle'}(2));
[I.img.features.pxList{'contactAngle'}]=transfoCoord2PixelList(I.img.type.M,'Line',I.img.features.positions{'contactAngle'},I.img.features.shape{'contactAngle'}(1));
set(S.W_V1,'UserData',I);
imgProcessing(S,0) 
    ...
    case {S.W_V2_H3_V2_T5_V2_H_push(1),S.W_V2_H3_V2_T5_V2_H_push(2)}
        ...
        for k=1:lvlMax
            switch k
                ...
                case 5
                    I.file.tab.full.Setting{dataNum}.binarisation.threshold=str2double(get(S.W_V2_H2_V3_T5_G_edit(1),'String'));
                    I.file.tab.full.Setting{dataNum}.binarisation.minDetection=str2double(get(S.W_V2_H2_V3_T5_G_edit(2),'String'));
                    I.file.tab.full.Setting{dataNum}.binarisation.surfCorrection=str2double(get(S.W_V2_H2_V3_T5_G_edit(3),'String'));
                    I.file.tab.full.Setting{dataNum}.binarisation.fill(1)=get(S.W_V2_H2_V3_T5_G_check(1),'value');
                    I.file.tab.full.Setting{dataNum}.binarisation.fill(2)=get(S.W_V2_H2_V3_T5_G_check(2),'value');
                case 6
                    I.file.tab.full.Setting{dataNum}.trackingMod=I.track.mod;
                ...
                case 7
                    P=get(S.W_V2_H2_V3_T6_G_pop,'String');
                    I.file.tab.full.Setting{dataNum}.contactAngle.method=P{get(S.W_V2_H2_V3_T6_G_pop,'value')};
                    I.file.tab.full.Setting{dataNum}.contactAngle.zone=str2double(get(S.W_V2_H2_V3_T6_G_edit(1),'String'));
                    I.file.tab.full.Setting{dataNum}.contactAngle.offset=str2double(get(S.W_V2_H2_V3_T6_G_edit(2),'String'));
                    I.file.tab.full.Setting{dataNum}.contactAngle.smoothVal=str2double(get(S.W_V2_H2_V3_T6_G_edit(3),'String'));
                    I.file.tab.full.Setting{dataNum}.contactAngle.Weight=str2double(get(S.W_V2_H2_V3_T6_G_edit(4),'String'));
                case 8
                    I.file.tab.full.Setting{dataNum}.trackingMod=I.track.mod;
                case 9
                    I.file.tab.full.Output{dataNum}.dropClass=I.class.drops.tab;
...
for i=1:length(steps2ini)
    switch steps2ini(i)
        ...
        case 7 %Binarisation
            set(S.W_V2_H2_V3_T5_G_edit(1),'string',0)
            set(S.W_V2_H2_V3_T5_G_edit(2),'string',5)
            set(S.W_V2_H2_V3_T5_G_edit(3),'string',0)
            set(S.W_V2_H2_V3_T5_G_edit(4),'string',0)
            set(S.W_V2_H2_V3_T5_G_edit(5),'string',5)
            set(S.W_V2_H2_V3_T5_G_check(1),'value',1)
            set(S.W_V2_H2_V3_T5_G_check(2),'value',0)
        case 8 %Tracking
            I.track.new=[];
        ...
        case 9 %Contact angle
            set(S.W_V2_H2_V3_T6_G_edit(1),'string',10)
            set(S.W_V2_H2_V3_T6_G_edit(2),'string',0)
            set(S.W_V2_H2_V3_T6_G_edit(3),'string',0.7)
            set(S.W_V2_H2_V3_T6_G_edit(4),'string',2)
        ...
        for k=pr
            switch k
                ...
                case 5 % Binarisation: + Binary
                    if str2double(get(S.W_V2_H2_V3_T5_G_edit(1),'string'))==0
                        [greyThreshold]=getImgsBinarisedThreshold(I.img.type.E,I.img.type.S{1});
                        set(S.W_V2_H2_V3_T5_G_edit(1),'string',greyThreshold)
                    end
                    [I.img.type.B]=getImgsBinarised(I.img.type.E,I.img.type.S{1},str2double(get(S.W_V2_H2_V3_T5_G_edit(1),'string')));
                    [I.img.type.B]=getImgsBinFiltered(I.img.type.B,I.img.type.S{1},str2double(get(S.W_V2_H2_V3_T5_G_edit(3),'string')),str2double(get(S.W_V2_H2_V3_T5_G_edit(2),'string')));
                    [I.img.type.B]=getImgsBinFilled(I.img.type.B,I.img.type.S{1},get(S.W_V2_H2_V3_T5_G_check(1),'value'),get(S.W_V2_H2_V3_T5_G_check(2),'value'));
                    [I.track.ori,I.img.type.L]=getObjProp(I.img.type.B,I.img.type.S{1});              
                    if get(S.W_V2_H1_V2_V5_H_pop,'value')==2
                        %Su=true(size(I.img.type.BGu{1}));
                        Su=getUnderneathFocus(I.img.type.BGu{1});
                        if str2double(get(S.W_V2_H2_V3_T5_G_edit(4),'string'))==0
                            [greyThreshold]=getUnderImgsBinarisedThreshold(I.img.type.Eu,Su);
                            set(S.W_V2_H2_V3_T5_G_edit(4),'string',greyThreshold)
                        end
                    	[I.img.type.Bu]=getImgsBinarised(I.img.type.Eu,Su,str2double(get(S.W_V2_H2_V3_T5_G_edit(4),'string')));
                        [I.img.type.Bu]=getImgsBinFiltered(I.img.type.Bu,Su,0,str2double(get(S.W_V2_H2_V3_T5_G_edit(5),'string')));
                ...
                case 7 % Main drop info
                    ...
                    [I.img.features.pxList{'contactAngle'}]=transfoCoord2PixelList(I.img.type.M,'Line',I.img.features.positions{'contactAngle'},I.img.features.shape{'contactAngle'}(1));    
                    if get(S.W_V2_H1_V2_V5_H_pop,'value')==2
                        [I.obs.mainDrop,I.img.features.pxList{'underneath'}]=getMainDropUnderObs(I.obs.mainDrop,I.img.type.Bu,get(S.W_V2_H2_V3_T7_G_check,'value'),str2double(get(S.W_V2_H2_V3_T7_G_edit,'string')));
                    end
