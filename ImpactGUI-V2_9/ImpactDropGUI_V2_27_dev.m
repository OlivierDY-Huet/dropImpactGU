...
S.W_V2_H2_V3_T2_G_edit(1)=uicontrol('Style','edit','String','75','Parent',S.W_V2_H2_V3_T2_G); %--
uix.Empty('Parent',S.W_V2_H2_V3_T2_G);
...
uix.Empty('Parent',S.W_V2_H2_V3_T2_G);
set(S.W_V2_H2_V3_T2_G,'Widths',[-2 -1 -1 -1],'Heights',[-1 -1]);
...
S.W_V2_H2_V3_T3_G_edit(1)=uicontrol('Style','edit','String','75','Parent',S.W_V2_H2_V3_T3_G); %--
uix.Empty('Parent',S.W_V2_H2_V3_T3_G);
...
uix.Empty('Parent',S.W_V2_H2_V3_T3_G);
set(S.W_V2_H2_V3_T3_G,'Widths',[-2 -1 -1 -1],'Heights',[-1 -1]);
...
S.W_V2_H2_V3_T4_G_edit=uicontrol('Style','edit','String','0','Parent',S.W_V2_H2_V3_T4_G); %--
uix.Empty('Parent',S.W_V2_H2_V3_T4_G)
S.W_V2_H2_V3_T4_G_push=uicontrol('Style','pushbutton','String','Default','Parent',S.W_V2_H2_V3_T4_G); %--
uix.Empty('Parent',S.W_V2_H2_V3_T4_G)
set(S.W_V2_H2_V3_T4_G,'Widths',[-1 -1 -1],'Heights',[-1 -1]);
...
uix.Empty('Parent',S.W_V2_H2_V3_T5_G)
set(S.W_V2_H2_V3_T5_G,'Widths',[-1 -1 -1],'Heights',[-1 -1]);
...
set(S.W_V2_H2_V3_T11_G_check,'Enable','off')
...
%             end
        ...
        for k=1:I.file.tab.full.Lvl{dataNum}
            switch k
                ...
                case 3
                    set(S.W_V2_H2_V3_T4_G_edit,'string',I.file.tab.full.Setting{dataNum}.backgroundNbr)
                case 4
...
[h,S]=varargin{[1,3]};  % Get calling handle and structure
switch h  % Who called?
    case {S.W_V2_H2_V3_T2_G_check(:)}
    case S.W_V2_H2_V3_T2_G_edit
         set(h,'string',min([100,max([0,round(str2double(get(h,'string')))])]))
end
imgProcessing(S,2)
%set(S.W_V2_H2_V3_T2_G_check(2),'Callback',{@W_V2_H2_V3_T2_G_sharedCall,S});  
    ...
    case {S.W_V2_H3_V2_T5_V2_H_push(1),S.W_V2_H3_V2_T5_V2_H_push(2)}
        ...
        for k=1:lvlMax
            switch k
                ...
                case 3
                    I.file.tab.full.Setting{dataNum}.backgroundNbr=str2double(get(S.W_V2_H2_V3_T4_G_edit,'string'));
                case 4
...
for i=1:length(steps2ini)
    switch steps2ini(i)
        ...
        case 5 %Background            
            set(S.W_V2_H2_V3_T4_G_edit,'string',0)
        case 6 %Limit           
            set(S.W_V2_H2_V3_T6_H2_V_radio(1),'Value',1)
...
%                         end
                        [I.img.type.M]=getImgsCorrected(I.img.type.M,str2double(get(S.W_V2_H2_V3_T2_G_edit,'string')));
                    end
...
%                             set(S.W_V2_H2_V3_T3_G_edit,'string',percLimit)
                        %end
                        [I.img.type.Mu]=getImgsCorrected(I.img.type.Mu,str2double(get(S.W_V2_H2_V3_T3_G_edit,'string')));
                    end
                ...
                case 3 % Background substraction
                    if str2double(get(S.W_V2_H2_V3_T4_G_edit,'string'))==0
                        [n_base]=getNbrBackground(I.img.type.M);
                        set(S.W_V2_H2_V3_T4_G_edit,'string',n_base);
                        set(S.W_V2_H2_V3_T5_G_edit,'string',n_base);
                    end
                   
                    [I.img.type.BG{1}]=getImgBackground(I.img.type.M,str2double(get(S.W_V2_H2_V3_T4_G_edit,'string')));
                    [I.img.type.E]=getImgsEnhanced(I.img.type.M,I.img.type.BG{1});
                    if get(S.W_V2_H1_V2_V5_H_pop,'value')==2
                        [I.img.type.BGu{1}]=getImgBackground(I.img.type.Mu,str2double(get(S.W_V2_H2_V3_T5_G_edit,'string')));
