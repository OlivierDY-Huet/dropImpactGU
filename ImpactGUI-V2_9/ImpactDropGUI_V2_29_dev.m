...
varRow={'addLines';'limitSurface';'centroid';'boundingBox';'contactAngle';'tracking';'drops';'class';'pinning';'contactLine'};    
...
I.img.features0.color{'contactLine'}=[255 0 0];
I.img.features0.color{'underAxes'}=[255 100 0];
...
I.img.features0.shape{'contactLine'}=1;
I.img.features0.shape{'class'}=1;
I.img.features0.shape{'pinning'}=1;
I.img.features0.shape{'underAxes'}=1;
...
S.W_V2=uix.Panel('Parent',S.W_V);
        ...
        S.W_V2_H2=uix.Panel('Title','ANALYSIS','Parent',S.W_V2_H);
            ...
            S.W_V2_H2_V3=uix.Panel('Title','Analysis settings','Parent',S.W_V2_H2_V);
                ...
                S.W_V2_H2_V3_T3=uix.Panel('Title','Filters','Parent',[]);
                S.W_V2_H2_V3_T4=uix.Panel('Title','Background','Parent',S.W_V2_H2_V3_T);
                S.W_V2_H2_V3_T5=uix.Panel('Title','Background','Parent',[]);
                S.W_V2_H2_V3_T6=uix.Panel('Title','Surface limit','Parent',S.W_V2_H2_V3_T);
                S.W_V2_H2_V3_T7=uix.Panel('Title','Light focus','Parent',[]);
                S.W_V2_H2_V3_T8=uix.Panel('Title','Binarisation','Parent',S.W_V2_H2_V3_T);
                S.W_V2_H2_V3_T9=uix.Panel('Title','Binarisation','Parent',[]);
                S.W_V2_H2_V3_T10=uix.Panel('Title','Contact angle','Parent',S.W_V2_H2_V3_T);
                S.W_V2_H2_V3_T11=uix.Panel('Title','Underneath','Parent',[]);
                S.W_V2_H2_V3_T.TabTitles={'lvl 1','lvl 2','lvl 3','lvl 4','lvl 5','lvl 7'};
                %S.W_V2_H2_V3_T.TabTitles={'lvl 1','lvl 2','lvl 2U','lvl 3','lvl 3U','lvl 4','lvl 4U','lvl 5','lvl 5U','lvl 7','lvl 7U'};
...
S.W_V2_H2_V3_T2_G_check(1)=uicontrol('Style','checkbox','String','Oscillation correction','value',0,'Parent',S.W_V2_H2_V3_T2_G);
uix.Empty('Parent',S.W_V2_H2_V3_T2_G);
uicontrol('Style','text','HorizontalAlignment','center','String','x','Parent',S.W_V2_H2_V3_T2_G); %--
S.W_V2_H2_V3_T2_G_edit(1)=uicontrol('Style','edit','String','1','Parent',S.W_V2_H2_V3_T2_G);
S.W_V2_H2_V3_T2_G_edit(2)=uicontrol('Style','edit','String','1','Parent',S.W_V2_H2_V3_T2_G);
uicontrol('Style','text','HorizontalAlignment','center','String','y','Parent',S.W_V2_H2_V3_T2_G); %--
S.W_V2_H2_V3_T2_G_edit(3)=uicontrol('Style','edit','String','1','Parent',S.W_V2_H2_V3_T2_G);
S.W_V2_H2_V3_T2_G_edit(4)=uicontrol('Style','edit','String','1','Parent',S.W_V2_H2_V3_T2_G);
uix.Empty('Parent',S.W_V2_H2_V3_T2_G); %--
uix.Empty('Parent',S.W_V2_H2_V3_T2_G);
uix.Empty('Parent',S.W_V2_H2_V3_T2_G);
uix.Empty('Parent',S.W_V2_H2_V3_T2_G); %--
S.W_V2_H2_V3_T2_G_check(2)=uicontrol('Style','checkbox','String','Median filter','value',0,'Parent',S.W_V2_H2_V3_T2_G);
S.W_V2_H2_V3_T2_G_check(3)=uicontrol('Style','checkbox','String','Sharpening filter','value',0,'Parent',S.W_V2_H2_V3_T2_G);
set(S.W_V2_H2_V3_T2_G,'Widths',[-1 -1 -1 -1 -1],'Heights',[-1 -1 -1]);

% Analysis settings, tab: lvl 2: Filters
S.W_V2_H2_V3_T3_G=uix.Grid('Parent',S.W_V2_H2_V3_T3);
uix.Empty('Parent',S.W_V2_H2_V3_T3_G);  %--
S.W_V2_H2_V3_T3_G_check(1)=uicontrol('Style','checkbox','String','Oscillation correction','value',0,'Parent',S.W_V2_H2_V3_T3_G);
uix.Empty('Parent',S.W_V2_H2_V3_T3_G);
uicontrol('Style','text','HorizontalAlignment','center','String','x','Parent',S.W_V2_H2_V3_T3_G); %--
S.W_V2_H2_V3_T3_G_edit(1)=uicontrol('Style','edit','String','1','Parent',S.W_V2_H2_V3_T3_G);
S.W_V2_H2_V3_T3_G_edit(2)=uicontrol('Style','edit','String','1','Parent',S.W_V2_H2_V3_T3_G);
uicontrol('Style','text','HorizontalAlignment','center','String','y','Parent',S.W_V2_H2_V3_T3_G); %--
S.W_V2_H2_V3_T3_G_edit(3)=uicontrol('Style','edit','String','1','Parent',S.W_V2_H2_V3_T3_G);
S.W_V2_H2_V3_T3_G_edit(4)=uicontrol('Style','edit','String','1','Parent',S.W_V2_H2_V3_T3_G);
uix.Empty('Parent',S.W_V2_H2_V3_T3_G); %--
uix.Empty('Parent',S.W_V2_H2_V3_T3_G);
uix.Empty('Parent',S.W_V2_H2_V3_T3_G);
uix.Empty('Parent',S.W_V2_H2_V3_T3_G); %--
S.W_V2_H2_V3_T3_G_check(2)=uicontrol('Style','checkbox','String','Median filter','value',0,'Parent',S.W_V2_H2_V3_T3_G);
S.W_V2_H2_V3_T3_G_check(3)=uicontrol('Style','checkbox','String','Sharpening filter','value',0,'Parent',S.W_V2_H2_V3_T3_G);
set(S.W_V2_H2_V3_T3_G,'Widths',[-1 -1 -1 -1 -1],'Heights',[-1 -1 -1]);

%--------------------------------------------------------------------------
% Analysis settings, tab: lvl 3: Background

S.W_V2_H2_V3_T4_G=uix.Grid('Parent',S.W_V2_H2_V3_T4);
uicontrol('Style','text','HorizontalAlignment','left','String','Number of images','Parent',S.W_V2_H2_V3_T4_G); %--
uicontrol('Style','text','HorizontalAlignment','left','String','Intensity modication','Parent',S.W_V2_H2_V3_T4_G);
S.W_V2_H2_V3_T4_G_edit(1)=uicontrol('Style','edit','String','0','Parent',S.W_V2_H2_V3_T4_G); %--
S.W_V2_H2_V3_T4_G_edit(2)=uicontrol('Style','edit','String','100','Parent',S.W_V2_H2_V3_T4_G);
uicontrol('Style','text','HorizontalAlignment','left','String','[Frames]','Parent',S.W_V2_H2_V3_T4_G); %--
uicontrol('Style','text','HorizontalAlignment','left','String','[%]','Parent',S.W_V2_H2_V3_T4_G);
S.W_V2_H2_V3_T4_G_push=uicontrol('Style','pushbutton','String','Default','Parent',S.W_V2_H2_V3_T4_G); %--
uix.Empty('Parent',S.W_V2_H2_V3_T4_G)
set(S.W_V2_H2_V3_T4_G,'Widths',[-1 -1 -1 -1],'Heights',[-1 -1]);

S.W_V2_H2_V3_T5_G=uix.Grid('Parent',S.W_V2_H2_V3_T5);
uicontrol('Style','text','HorizontalAlignment','left','String','Number of images','Parent',S.W_V2_H2_V3_T5_G); %--
uicontrol('Style','text','HorizontalAlignment','left','String','Intensity modication','Parent',S.W_V2_H2_V3_T5_G);
S.W_V2_H2_V3_T5_G_edit(1)=uicontrol('Style','edit','String','0','Parent',S.W_V2_H2_V3_T5_G); %--
S.W_V2_H2_V3_T5_G_edit(2)=uicontrol('Style','edit','String','100','Parent',S.W_V2_H2_V3_T5_G);
uicontrol('Style','text','HorizontalAlignment','left','String','[Frames]','Parent',S.W_V2_H2_V3_T5_G); %--
uicontrol('Style','text','HorizontalAlignment','left','String','[%]','Parent',S.W_V2_H2_V3_T5_G);
S.W_V2_H2_V3_T5_G_push=uicontrol('Style','pushbutton','String','Default','Parent',S.W_V2_H2_V3_T5_G); %--
uix.Empty('Parent',S.W_V2_H2_V3_T5_G)
set(S.W_V2_H2_V3_T5_G,'Widths',[-1 -1 -1 -1],'Heights',[-1 -1]);

%--------------------------------------------------------------------------
% Analysis settings, tab: lvl 4: Surf

S.W_V2_H2_V3_T6_H=uix.HBox('Parent',S.W_V2_H2_V3_T6);        
S.W_V2_H2_V3_T6_H1=uix.Panel('BorderType','none','Parent',S.W_V2_H2_V3_T6_H); %--
    S.W_V2_H2_V3_T6_H1_V=uix.VBox('Parent',S.W_V2_H2_V3_T6_H1);
    uix.Empty('Parent',S.W_V2_H2_V3_T6_H1_V);
    uix.Empty('Parent',S.W_V2_H2_V3_T6_H1_V);              
S.W_V2_H2_V3_T6_H2=uix.Panel('BorderType','none','Parent',S.W_V2_H2_V3_T6_H); %--
    S.W_V2_H2_V3_T6_H2_V=uix.VBox('Parent',S.W_V2_H2_V3_T6_H2);
    S.W_V2_H2_V3_T6_H2_V_radio(1)=uicontrol('Style','radiobutton','HorizontalAlignment','center','String','Line','Value',1,'Parent',S.W_V2_H2_V3_T6_H2_V);
    S.W_V2_H2_V3_T6_H2_V_radio(2)=uicontrol('Style','radiobutton','HorizontalAlignment','center','String','Background','Value',0,'Parent',S.W_V2_H2_V3_T6_H2_V);      
S.W_V2_H2_V3_T6_H3=uix.Panel('BorderType','none','Parent',S.W_V2_H2_V3_T6_H); %--
    S.W_V2_H2_V3_T6_H3_V=uix.VBox('Parent',S.W_V2_H2_V3_T6_H3);
    S.W_V2_H2_V3_T6_H3_V1=uix.Panel('BorderType','none','Parent',S.W_V2_H2_V3_T6_H3_V);
        S.W_V2_H2_V3_T6_H3_V1_H=uix.HBox('Parent',S.W_V2_H2_V3_T6_H3_V1);
        S.W_V2_H2_V3_T6_H3_V1_H_edit(1)=uicontrol('Style','edit','String','0','Parent',S.W_V2_H2_V3_T6_H3_V1_H);
        S.W_V2_H2_V3_T6_H3_V1_H1=uix.HButtonBox('Parent',S.W_V2_H2_V3_T6_H3_V1_H); 
            S.W_V2_H2_V3_T6_H3_V1_H1_push(1)=uicontrol('Style','pushbutton','String','+','Parent',S.W_V2_H2_V3_T6_H3_V1_H1);
            S.W_V2_H2_V3_T6_H3_V1_H1_push(2)=uicontrol('Style','pushbutton','String','-','Parent',S.W_V2_H2_V3_T6_H3_V1_H1);
        S.W_V2_H2_V3_T6_H3_V1_H_edit(2)=uicontrol('Style','edit','String','0','Parent',S.W_V2_H2_V3_T6_H3_V1_H);
        S.W_V2_H2_V3_T6_H3_V1_H2=uix.HButtonBox('Parent',S.W_V2_H2_V3_T6_H3_V1_H);
            S.W_V2_H2_V3_T6_H3_V1_H2_push(1)=uicontrol('Style','pushbutton','String','+','Parent',S.W_V2_H2_V3_T6_H3_V1_H2);
            S.W_V2_H2_V3_T6_H3_V1_H2_push(2)=uicontrol('Style','pushbutton','String','-','Parent',S.W_V2_H2_V3_T6_H3_V1_H2);
    S.W_V2_H2_V3_T6_H3_V2=uix.Panel('BorderType','none','Parent',S.W_V2_H2_V3_T6_H3_V);
        S.W_V2_H2_V3_T6_H3_V2_H=uix.HBox('Parent',S.W_V2_H2_V3_T6_H3_V2);
        S.W_V2_H2_V3_T6_H3_V2_H_edit=uicontrol('Style','edit','String','0','Parent',S.W_V2_H2_V3_T6_H3_V2_H);
        uix.Empty('Parent',S.W_V2_H2_V3_T6_H3_V2_H)       
S.W_V2_H2_V3_T6_H4=uix.Panel('BorderType','none','Parent',S.W_V2_H2_V3_T6_H); %--
S.W_V2_H2_V3_T6_H4_V=uix.VBox('Parent',S.W_V2_H2_V3_T6_H4);
S.W_V2_H2_V3_T6_H3_V2_push(1)=uicontrol('Style','pushbutton','String','Reset','Parent',S.W_V2_H2_V3_T6_H4_V);
S.W_V2_H2_V3_T6_H3_V2_push(2)=uicontrol('Style','pushbutton','String','Reset','Parent',S.W_V2_H2_V3_T6_H4_V);

% Analysis settings, tab: lvl 4 U: Focus
S.W_V2_H2_V3_T7_G=uix.Grid('Parent',S.W_V2_H2_V3_T7);
S.W_V2_H2_V3_T7_G_pop=uicontrol('Style','pop','HorizontalAlignment','left','String',{'no','yes'},'value',2,'Parent',S.W_V2_H2_V3_T7_G);%--
uix.Empty('Parent',S.W_V2_H2_V3_T7_G)
uix.Empty('Parent',S.W_V2_H2_V3_T7_G)    
S.W_V2_H2_V3_T7_G_edit=uicontrol('Style','edit','String','0','Parent',S.W_V2_H2_V3_T7_G); %--
uix.Empty('Parent',S.W_V2_H2_V3_T7_G)
uix.Empty('Parent',S.W_V2_H2_V3_T7_G)    
uicontrol('Style','text','HorizontalAlignment','left','String','[uint8]','Parent',S.W_V2_H2_V3_T7_G);%--
uix.Empty('Parent',S.W_V2_H2_V3_T7_G) 
uix.Empty('Parent',S.W_V2_H2_V3_T7_G)
S.W_V2_H2_V3_T7_G_push=uicontrol('Style','pushbutton','String','Reset','Parent',S.W_V2_H2_V3_T7_G);%--
uix.Empty('Parent',S.W_V2_H2_V3_T7_G)
uix.Empty('Parent',S.W_V2_H2_V3_T7_G)
uix.Empty('Parent',S.W_V2_H2_V3_T7_G)%--
uix.Empty('Parent',S.W_V2_H2_V3_T7_G)
uix.Empty('Parent',S.W_V2_H2_V3_T7_G)
set(S.W_V2_H2_V3_T7_G,'Widths',[-1 -1 -0.5 1 -2],'Heights',[-1 -1 -1]);

%--------------------------------------------------------------------------
% Analysis settings, tab: lvl 5: Bin

S.W_V2_H2_V3_T8_G=uix.Grid('Parent',S.W_V2_H2_V3_T8);
uicontrol('Style','text','HorizontalAlignment','left','String','Threshold liq./air','Parent',S.W_V2_H2_V3_T8_G); %--
uicontrol('Style','text','HorizontalAlignment','left','String','Minimum detection','Parent',S.W_V2_H2_V3_T8_G);
uicontrol('Style','text','HorizontalAlignment','left','String','Surface correction','Parent',S.W_V2_H2_V3_T8_G);
...
uicontrol('Style','text','HorizontalAlignment','left','String','[uint8]','Parent',S.W_V2_H2_V3_T8_G); %--
uicontrol('Style','text','HorizontalAlignment','left','String','[px]','Parent',S.W_V2_H2_V3_T8_G);
uicontrol('Style','text','HorizontalAlignment','left','String','[px]','Parent',S.W_V2_H2_V3_T8_G);
S.W_V2_H2_V3_T8_G_check(1)=uicontrol('Style','checkbox','String','Fill above surface','value',1,'Parent',S.W_V2_H2_V3_T8_G); %--
S.W_V2_H2_V3_T8_G_check(2)=uicontrol('Style','checkbox','String','Fill on surface','value',1,'Parent',S.W_V2_H2_V3_T8_G);
S.W_V2_H2_V3_T8_G_push=uicontrol('Style','pushbutton','String','Default','Parent',S.W_V2_H2_V3_T8_G);
set(S.W_V2_H2_V3_T8_G,'Widths',[-2 -1 -0.5 -2],'Heights',[-1 -1 -1]);


% Analysis settings, tab: lvl 5 U: Bin

S.W_V2_H2_V3_T9_G=uix.Grid('Parent',S.W_V2_H2_V3_T9);
S.W_V2_H2_V3_T9_G_pop=uicontrol('Style','pop','HorizontalAlignment','left','String',{'Dark','Dark + Bright'},'value',1,'Parent',S.W_V2_H2_V3_T9_G); %--
uix.Empty('Parent',S.W_V2_H2_V3_T9_G)
uix.Empty('Parent',S.W_V2_H2_V3_T9_G)
uix.Empty('Parent',S.W_V2_H2_V3_T9_G)%--
uix.Empty('Parent',S.W_V2_H2_V3_T9_G)
uix.Empty('Parent',S.W_V2_H2_V3_T9_G)
uicontrol('Style','text','HorizontalAlignment','left','String','Dark threshold','Parent',S.W_V2_H2_V3_T9_G); %--
uicontrol('Style','text','HorizontalAlignment','left','String','Bright threshold','Parent',S.W_V2_H2_V3_T9_G);
uicontrol('Style','text','HorizontalAlignment','left','String','Minimum detection','Parent',S.W_V2_H2_V3_T9_G);
S.W_V2_H2_V3_T9_G_edit(1)=uicontrol('Style','edit','String','0','Parent',S.W_V2_H2_V3_T9_G); %--
S.W_V2_H2_V3_T9_G_edit(2)=uicontrol('Style','edit','String','255','Parent',S.W_V2_H2_V3_T9_G);
set(S.W_V2_H2_V3_T9_G_edit(2),'enable','off')
S.W_V2_H2_V3_T9_G_edit(3)=uicontrol('Style','edit','String','0','Parent',S.W_V2_H2_V3_T9_G);
uicontrol('Style','text','HorizontalAlignment','left','String','[uint8]','Parent',S.W_V2_H2_V3_T9_G);%--
uicontrol('Style','text','HorizontalAlignment','left','String','[uint8]','Parent',S.W_V2_H2_V3_T9_G);
uicontrol('Style','text','HorizontalAlignment','left','String','[px]','Parent',S.W_V2_H2_V3_T9_G);
S.W_V2_H2_V3_T9_G_push=uicontrol('Style','pushbutton','String','Default','Parent',S.W_V2_H2_V3_T9_G);%--
uix.Empty('Parent',S.W_V2_H2_V3_T9_G)
uix.Empty('Parent',S.W_V2_H2_V3_T9_G)
set(S.W_V2_H2_V3_T9_G,'Widths',[-2 -0.5 -1.5 -1 -0.5 -1],'Heights',[-1 -1 -1]);

%--------------------------------------------------------------------------
% Analysis settings, tab: lvl 7: CA

S.W_V2_H2_V3_T10_G=uix.Grid('Parent',S.W_V2_H2_V3_T10);
uicontrol('Style','text','HorizontalAlignment','left','String','Method','Parent',S.W_V2_H2_V3_T10_G);  %--
uicontrol('Style','text','HorizontalAlignment','left','String','Zone','Parent',S.W_V2_H2_V3_T10_G);
uix.Empty('Parent',S.W_V2_H2_V3_T10_G)
S.W_V2_H2_V3_T10_G_pop=uicontrol('Style','pop','HorizontalAlignment','left','String',{'None','Poly2-Auto','Poly2','Spline','Gradient'},'value',1,'Parent',S.W_V2_H2_V3_T10_G); %--
S.W_V2_H2_V3_T10_G_edit(1)=uicontrol('Style','edit','String','0','Parent',S.W_V2_H2_V3_T10_G);
S.W_V2_H2_V3_T10_G_push=uicontrol('Style','pushbutton','String','Default','Parent',S.W_V2_H2_V3_T10_G);
uix.Empty('Parent',S.W_V2_H2_V3_T10_G)  %--
uicontrol('Style','text','HorizontalAlignment','left','String','[px]','Parent',S.W_V2_H2_V3_T10_G);
uix.Empty('Parent',S.W_V2_H2_V3_T10_G)
uicontrol('Style','text','HorizontalAlignment','left','String','Offset','Parent',S.W_V2_H2_V3_T10_G);  %--
uicontrol('Style','text','HorizontalAlignment','left','String','Smooth','Parent',S.W_V2_H2_V3_T10_G);
uicontrol('Style','text','HorizontalAlignment','left','String','Weight','Parent',S.W_V2_H2_V3_T10_G);
S.W_V2_H2_V3_T10_G_edit(2)=uicontrol('Style','edit','String','0','Parent',S.W_V2_H2_V3_T10_G);  %--
S.W_V2_H2_V3_T10_G_edit(3)=uicontrol('Style','edit','String','0','Parent',S.W_V2_H2_V3_T10_G);
S.W_V2_H2_V3_T10_G_edit(4)=uicontrol('Style','edit','String','0','Parent',S.W_V2_H2_V3_T10_G);
uicontrol('Style','text','HorizontalAlignment','left','String','[px]','Parent',S.W_V2_H2_V3_T10_G);  %--
uicontrol('Style','text','HorizontalAlignment','left','String','(0-1)','Parent',S.W_V2_H2_V3_T10_G);  %--
uix.Empty('Parent',S.W_V2_H2_V3_T10_G)

set(S.W_V2_H2_V3_T10_G,'Widths',[-1 -1 -0.5 -1 -1 -0.5],'Heights',[-1 -1 -1]);   

% Analysis settings, tab: lvl 7U: Under

S.W_V2_H2_V3_T11_G=uix.Grid('Parent',S.W_V2_H2_V3_T11);

S.W_V2_H2_V3_T11_G_check=uicontrol('Style','checkbox','String','Complete under','value',1,'Parent',S.W_V2_H2_V3_T11_G);%--
uix.Empty('Parent',S.W_V2_H2_V3_T11_G)
uix.Empty('Parent',S.W_V2_H2_V3_T11_G)
S.W_V2_H2_V3_T11_G_edit=uicontrol('Style','edit','String','0','Parent',S.W_V2_H2_V3_T11_G);%--
uix.Empty('Parent',S.W_V2_H2_V3_T11_G)
uix.Empty('Parent',S.W_V2_H2_V3_T11_G)
uix.Empty('Parent',S.W_V2_H2_V3_T11_G)%--
uix.Empty('Parent',S.W_V2_H2_V3_T11_G)
...
set(S.W_V2_H2_V3_T11_G,'Widths',[-2 -1 -3],'Heights',[-1 -1 -1]); 
...
S.cm=uicontextmenu;
S.um(1)=uimenu('label','Pixel value','Parent',[]);
S.um(2)=uimenu('label','Zoom','Parent',[]);
    S.ums(1)=uimenu('label','IN','Parent',S.um(2));
    S.ums(2)=uimenu('label','OUT','Parent',S.um(2));
S.um(3)= uimenu('label','Image modification','Parent',[]);
...
S.um(4)=uimenu('label','Control zone','Parent',[]);
S.um(5)=uimenu('label','Set surface limit','Parent',[]);    
S.um(6)=uimenu('label','Drop ID:','Parent',[]);
S.um(7)=uimenu('label','Change tracking','Parent',[]);
    S.ums(6)=uimenu('label','Last frame','Parent',S.um(7));
    S.ums(7)=uimenu('label','New drop','Parent',S.um(7));
    S.ums(8)=uimenu('label','Fuse drops','Parent',S.um(7));
    S.ums(9)=uimenu('label','Associate drops','Parent',S.um(7));
    S.ums(10)=uimenu('label','Undo last change','Parent',S.um(7));
S.um(8)=uimenu('label','Drop class: ','Parent',[]);
S.um(9)=uimenu('label','Change class','Parent',[]);
    S.ums(11)=uimenu('label',I.class.drops.text{1},'Parent',S.um(9));
    S.ums(12)=uimenu('label',I.class.drops.text{2},'Parent',S.um(9));
    S.ums(13)=uimenu('label',I.class.drops.text{3},'Parent',S.um(9));
    S.ums(14)=uimenu('label',I.class.drops.text{4},'Parent',S.um(9));
    S.ums(15)=uimenu('label',I.class.drops.text{5},'Parent',S.um(9));
S.um(10)=uimenu('label','Pinning options','Parent',[]);
    S.ums(16)=uimenu('label','Add drop as pinned','Parent',S.um(10));
    S.ums(17)=uimenu('label','Erase last added drop','Parent',S.um(10));
S.um(11)=uimenu('label','Erase last added drop','Parent',[]);
S.um(12)=uimenu('label','Drop ID:','Parent',[]);
S.um(13)=uimenu('label','Change limit','Parent',[]);
    S.ums(18)=uimenu('label','Unique','Parent',S.um(13));
    S.ums(19)=uimenu('label','Common','Parent',S.um(13));
    S.ums(20)=uimenu('label','Ignore','Parent',S.um(13));
S.um(14)=uimenu('label','Drop type:','Parent',[]);
S.um(15)=uimenu('label','Change type','Parent',[]);
    S.ums(21)=uimenu('label','Central','Parent',S.um(15));
    S.ums(22)=uimenu('label','Peripheral','Parent',S.um(15));
    S.ums(23)=uimenu('label','External','Parent',S.um(15));   
S.um(16)=uimenu('label','Volume method:','Parent',[]);
S.um(17)=uimenu('label','Change method','Parent',[]);
    S.ums(24)=uimenu('label','Spheroid','Parent',S.um(17));
    S.ums(25)=uimenu('label','Stacked cylinders','Parent',S.um(17));
S.um(18)=uimenu('label','Relative volume:','Parent',[]);  
...
%--------------------------------------------------------------------------
% Analysis settings, tab: lvl 2: Filters
set([S.W_V2_H2_V3_T2_G_check(:);S.W_V2_H2_V3_T2_G_edit(:)],'Call',{@W_V2_H2_V3_T2_G_sharedCall,S});
% Analysis settings, tab: lvl 2: Filters
set([S.W_V2_H2_V3_T3_G_check(:);S.W_V2_H2_V3_T3_G_edit(:)],'Call',{@W_V2_H2_V3_T3_G_sharedCall,S});

%--------------------------------------------------------------------------
% Analysis settings, tab: lvl 3: Bg
set([S.W_V2_H2_V3_T4_G_edit(:);S.W_V2_H2_V3_T4_G_push],'Call',{@W_V2_H2_V3_T4_G_sharedCall,S}) % Shared Callback

% Analysis settings, tab: lvl 3: Bg
set([S.W_V2_H2_V3_T5_G_edit(:);S.W_V2_H2_V3_T5_G_push],'Call',{@W_V2_H2_V3_T5_G_sharedCall,S}) % Shared Callback

%--------------------------------------------------------------------------
% Analysis settings, tab: lvl 4: Surf
set([S.W_V2_H2_V3_T6_H2_V_radio(:)],'Call',{@W_V2_H2_V3_T6_H2_V_radioCall,S})   
set([S.W_V2_H2_V3_T6_H3_V1_H_edit(:);S.W_V2_H2_V3_T6_H3_V1_H1_push(:);S.W_V2_H2_V3_T6_H3_V1_H2_push(:)],'Call',{@W_V2_H2_V3_T6_H3_V1_H_sharedCall,S});
set(S.W_V2_H2_V3_T6_H3_V2_H_edit,'Callback',{@W_V2_H2_V3_T6_H3_V2_H_editCall,S})
set([S.W_V2_H2_V3_T6_H3_V2_push(:)],'Call',{@W_V2_H2_V3_T6_H3_V2_H_sharedCall,S});

%  Analysis settings, tab: lvl 4: Focus
set([S.W_V2_H2_V3_T7_G_pop;S.W_V2_H2_V3_T7_G_edit;S.W_V2_H2_V3_T7_G_push],'Call',{@W_V2_H2_V3_T7_sharedCall,S});

%--------------------------------------------------------------------------
% Analysis settings, tab: lvl 5: Bin
set([S.W_V2_H2_V3_T8_G_edit(:);S.W_V2_H2_V3_T8_G_check(:);S.W_V2_H2_V3_T8_G_push],'Call',{@W_V2_H2_V3_T8_G_sharedCall,S});
set([S.W_V2_H2_V3_T9_G_pop;S.W_V2_H2_V3_T9_G_edit(:);S.W_V2_H2_V3_T9_G_push],'Call',{@W_V2_H2_V3_T9_G_sharedCall,S});

%--------------------------------------------------------------------------
% Analysis settings, tab: lvl 7: CA + underneath
set([S.W_V2_H2_V3_T10_G_pop;S.W_V2_H2_V3_T10_G_edit(:);S.W_V2_H2_V3_T10_G_push],'Call',{@W_V2_H2_V3_T10_G_sharedCall,S}) % Shared Callback
set([S.W_V2_H2_V3_T11_G_edit;S.W_V2_H2_V3_T11_G_check],'Call',{@W_V2_H2_V3_T11_G_sharedCall,S}) % Shared Callback
...
set(S.um(4),'Callback',{@umControl_call,S})
set(S.um(5),'Callback',{@umLine_call,S})
set([S.ums(6:10)],'Callback',{@umTrack,S});
set([S.ums(11:15)],'Callback',{@umClass,S});
set([S.um(11),S.ums(16:25)],'Callback',{@umPinning,S});
...
%             end
        ...
        for k=1:I.file.tab.full.Lvl{dataNum}
            switch k
                ...
                case 2
                    set(S.W_V2_H2_V3_T2_G_check(2),'value',I.file.tab.full.Setting{dataNum}.filters.median)
                    set(S.W_V2_H2_V3_T2_G_check(3),'value',I.file.tab.full.Setting{dataNum}.filters.sharpening)               
                case 3
                    set(S.W_V2_H2_V3_T4_G_edit(1),'string',I.file.tab.full.Setting{dataNum}.backgroundNbr)
                case 4
                    if strcmp(S.W_V2_H2_V3_T6_H2_V_radio(1),I.file.tab.full.Setting{dataNum}.surface.type)
                        set(S.W_V2_H2_V3_T6_H2_V_radio(1),'value',1)
                        set(S.W_V2_H2_V3_T6_H2_V_radio(0),'value',1)
                        set(S.W_V2_H2_V3_T6_H3_V1_H_edit(1),'string',I.file.tab.full.Setting{dataNum}.surface.val(1))
                        set(S.W_V2_H2_V3_T6_H3_V1_H_edit(2),'string',I.file.tab.full.Setting{dataNum}.surface.val(2))
                    else
                        set(S.W_V2_H2_V3_T6_H2_V_radio(0),'value',1)
                        set(S.W_V2_H2_V3_T6_H2_V_radio(1),'value',1)
                        set(S.W_V2_H2_V3_T6_H3_V2_H_edit,'string',I.file.tab.full.Setting{dataNum}.surface.val)
                    end
                case 5
                    set(S.W_V2_H2_V3_T8_G_edit(1),'string',I.file.tab.full.Setting{dataNum}.binarisation.threshold)
                    set(S.W_V2_H2_V3_T8_G_edit(2),'string',I.file.tab.full.Setting{dataNum}.binarisation.minDetection)
                    set(S.W_V2_H2_V3_T8_G_edit(3),'string',I.file.tab.full.Setting{dataNum}.binarisation.surfCorrection)
                    set(S.W_V2_H2_V3_T8_G_check(1),'value',I.file.tab.full.Setting{dataNum}.binarisation.fill(1))
                    set(S.W_V2_H2_V3_T8_G_check(2),'value',I.file.tab.full.Setting{dataNum}.binarisation.fill(2))
                case 6
                ...
                case 7
                    P=get(S.W_V2_H2_V3_T10_G_pop,'String');
                    set(S.W_V2_H2_V3_T10_G_pop,'value',find(strcmp(I.file.tab.full.Setting{dataNum}.contactAngle.method,P)==1))
                    set(S.W_V2_H2_V3_T10_G_edit(1),'string',I.file.tab.full.Setting{dataNum}.contactAngle.zone)
                    set(S.W_V2_H2_V3_T10_G_edit(2),'string',I.file.tab.full.Setting{dataNum}.contactAngle.offset)
                    set(S.W_V2_H2_V3_T10_G_edit(3),'string',I.file.tab.full.Setting{dataNum}.contactAngle.smoothVal)
                    set(S.W_V2_H2_V3_T10_G_edit(4),'string',I.file.tab.full.Setting{dataNum}.contactAngle.Weight)
                case 8
                    I.track.mod=I.file.tab.full.Setting{dataNum}.trackingMod;
                case 9
...
switch h  % Who called?
    case S.W_V2_H1_V2_V5_H_pop
        ...
        set(S.W_V2_H2_V3_T10,'Parent',[])
        set(S.W_V2_H2_V3_T11,'Parent',[])
        if get(h,'value')==1
        ...
        for k=1:length(tabRef)
            switch tabRef(k)
                ...
                case 3
                    ...
                    set(S.W_V2_H2_V3_T3_G,'Parent',S.W_V2_H2_V3_T3);
                case 4
                    set(S.W_V2_H2_V3_T4,'Parent',S.W_V2_H2_V3_T)
                    set(S.W_V2_H2_V3_T4_G,'Parent',S.W_V2_H2_V3_T4);
                case 5
                ...
                case 6
                    ...
                    set(S.W_V2_H2_V3_T6_H,'Parent',S.W_V2_H2_V3_T6);
                case 7
                ...
                case 10
                    set(S.W_V2_H2_V3_T10,'Parent',S.W_V2_H2_V3_T)
                    set(S.W_V2_H2_V3_T10_G,'Parent',S.W_V2_H2_V3_T10);
                case 11
                    set(S.W_V2_H2_V3_T11,'Parent',S.W_V2_H2_V3_T)
                    set(S.W_V2_H2_V3_T11_G,'Parent',S.W_V2_H2_V3_T11);
            end
        end
        if get(h,'value')==1
            S.W_V2_H2_V3_T.TabTitles={'lvl 1','lvl 2','lvl 3','lvl 4','lvl 5','lvl 7'};
...
str={'Additional lines';'Surface limit';'Centroid';'Bounding box';'Contact angle';'Tracking lines';'contactLine';'underAxes'};
switch h  % Who called?
...
%--------------------------------------------------------------------------
% Analysis settings, tab: lvl 2: Filters
function []=W_V2_H2_V3_T2_G_sharedCall(varargin)
[h,S]=varargin{[1,3]};  % Get calling handle and structure
switch h  % Who called?
    case S.W_V2_H2_V3_T2_G_check(1)
        if get(h,'value')==0
           % set(S.W_V2_H2_V3_T2_G_edit(:),'enable','off')
        else
           % set(S.W_V2_H2_V3_T2_G_edit(:),'enable','on')
        end
    case {S.W_V2_H2_V3_T2_G_check(1),S.W_V2_H2_V3_T2_G_check(2)}
        %nothing
    case {S.W_V2_H2_V3_T2_G_edit(:)}
        set(h,'string',round(str2double(get(h,'string'))))
        xMax=str2double(get(S.W_V2_H2_V3_T1_G_edit(2),'string'))-str2double(get(S.W_V2_H2_V3_T1_G_edit(1),'string'))+1;        
        if get(S.W_V2_H1_V2_V5_H_pop,'value')==0
            yMax=str2double(get(S.W_V2_H2_V3_T1_G_edit(4),'string'))-str2double(get(S.W_V2_H2_V3_T1_G_edit(3),'string'))+1;
        else 
            yMax=str2double(get(W_V2_H1_V2_V5_H_edit,'string'))-str2double(get(S.W_V2_H2_V3_T1_G_edit(3),'string'))+1;
        end
        switch h
            case {S.W_V2_H2_V3_T2_G_edit(1:2)}
                set(h,'string',max([0,min([str2double(get(h,'string')),xMax])]))
                switch h
                    case S.W_V2_H2_V3_T2_G_edit(1)
                        set(h,'string',min([str2double(get(h,'string')),str2double(get(S.W_V2_H2_V3_T2_G_edit(2),'string'))]))
                    case S.W_V2_H2_V3_T2_G_edit(2)
                        set(h,'string',max([str2double(get(h,'string')),str2double(get(S.W_V2_H2_V3_T2_G_edit(1),'string'))]))
                end
            case {S.W_V2_H2_V3_T2_G_edit(3:4)}
                set(h,'string',max([0,min([str2double(get(h,'string')),yMax])]))
                switch h
                    case S.W_V2_H2_V3_T2_G_edit(3)
                        set(h,'string',min([str2double(get(h,'string')),str2double(get(S.W_V2_H2_V3_T2_G_edit(4),'string'))]))
                    case S.W_V2_H2_V3_T2_G_edit(4)
                        set(h,'string',max([str2double(get(h,'string')),str2double(get(S.W_V2_H2_V3_T2_G_edit(3),'string'))]))
                end    
        end
end
imgProcessing(S,2)
...
%--------------------------------------------------------------------------
% Analysis settings, tab: lvl 2: Filters
function []=W_V2_H2_V3_T3_G_sharedCall(varargin)
[h,S]=varargin{[1,3]};  % Get calling handle and structure
switch h  % Who called?
    case S.W_V2_H2_V3_T3_G_check(1)
        if get(h,'value')==0
            %set(S.W_V2_H2_V3_T3_G_edit(:),'enable','off')
        else
            %set(S.W_V2_H2_V3_T3_G_edit(:),'enable','on')
        end
    case {S.W_V2_H2_V3_T3_G_check(1),S.W_V2_H2_V3_T3_G_check(2)}
        %nothing
    case {S.W_V2_H2_V3_T3_G_edit(:)}
        set(h,'string',round(str2double(get(h,'string'))))
        xMax=str2double(get(S.W_V2_H2_V3_T1_G_edit(2),'string'))-str2double(get(S.W_V2_H2_V3_T1_G_edit(1),'string'))+1;        
        if get(S.W_V2_H1_V2_V5_H_pop,'value')==0
            yMax=str2double(get(S.W_V2_H2_V3_T1_G_edit(4),'string'))-str2double(get(S.W_V2_H2_V3_T1_G_edit(3),'string'))+1;
        else
            yMax=str2double(get(S.W_V2_H2_V3_T1_G_edit(4),'string'))-str2double(get(W_V2_H1_V2_V5_H_edit,'string'));
        end
        switch h
            case {S.W_V2_H2_V3_T3_G_edit(1:2)}
                set(h,'string',max([0,min([str2double(get(h,'string')),xMax])]))
                switch h
                    case S.W_V2_H2_V3_T3_G_edit(1)
                        set(h,'string',min([str2double(get(h,'string')),str2double(get(S.W_V2_H2_V3_T3_G_edit(2),'string'))]))
                    case S.W_V2_H2_V3_T3_G_edit(2)
                        set(h,'string',max([str2double(get(h,'string')),str2double(get(S.W_V2_H2_V3_T3_G_edit(1),'string'))]))
                end
            case {S.W_V2_H2_V3_T3_G_edit(3:4)}
                set(h,'string',max([0,min([str2double(get(h,'string')),yMax])]))
                switch h
                    case S.W_V2_H2_V3_T3_G_edit(3)
                        set(h,'string',min([str2double(get(h,'string')),str2double(get(S.W_V2_H2_V3_T3_G_edit(4),'string'))]))
                    case S.W_V2_H2_V3_T3_G_edit(4)
                        set(h,'string',max([str2double(get(h,'string')),str2double(get(S.W_V2_H2_V3_T3_G_edit(3),'string'))]))
                end    
        end
end
imgProcessing(S,2)
...
function []=W_V2_H2_V3_T4_G_sharedCall(varargin) % Number of images for the background
[h,S]=varargin{[1,3]};  % Get calling handle and structure
I=get(S.W_V1,'UserData');
switch h  % Who called?
    case S.W_V2_H2_V3_T4_G_edit(1)
        set(h,'string',min([abs(round(str2double(get(h,'string')))),I.img.info.nbr]))
    case S.W_V2_H2_V3_T4_G_edit(2)
        set(h,'string',abs(round(str2double(get(h,'string')))))
    case S.W_V2_H2_V3_T4_G_push
        [S]=initialPara(S,5);
end
imgProcessing(S,3)
end 
...
function []=W_V2_H2_V3_T5_G_sharedCall(varargin) % Number of images for the background
[h,S]=varargin{[1,3]};  % Get calling handle and structure
I=get(S.W_V1,'UserData');
switch h  % Who called?
    case S.W_V2_H2_V3_T5_G_edit(1)
        set(h,'string',min([abs(round(str2double(get(h,'string')))),I.img.info.nbr]))
   case S.W_V2_H2_V3_T5_G_edit(2)
        set(h,'string',abs(round(str2double(get(h,'string')))))
...
function []=W_V2_H2_V3_T6_H2_V_radioCall(varargin) %Manage the surface limit options
[h,S]=varargin{[1,3]};  % Get calling handle and structure
switch h  % Who called?
    case S.W_V2_H2_V3_T6_H2_V_radio(1)
        set(S.W_V2_H2_V3_T6_H2_V_radio(2),'Value',0)       
        set(S.W_V2_H2_V3_T6_H3_V1,'Visible','on') 
        set(S.W_V2_H2_V3_T6_H3_V2_push(1),'Visible','on')
        set(S.W_V2_H2_V3_T6_H3_V2_H_edit,'Visible','off')
        set(S.W_V2_H2_V3_T6_H3_V2_push(2),'Visible','off') 
      
    case S.W_V2_H2_V3_T6_H2_V_radio(2)
        set(S.W_V2_H2_V3_T6_H2_V_radio(1),'Value',0);
        set(S.W_V2_H2_V3_T6_H3_V1,'Visible','off')
        set(S.W_V2_H2_V3_T6_H3_V2_push(1),'Visible','off')
        set(S.W_V2_H2_V3_T6_H3_V2_H_edit,'Visible','on')
        set(S.W_V2_H2_V3_T6_H3_V2_push(2),'Visible','on') 
end

imgProcessing(S,4)        
end
function []=W_V2_H2_V3_T6_H3_V1_H_sharedCall(varargin) % Manage the limit (line)
[h,S]=varargin{[1,3]};  % Get calling handle and structure
I=get(S.W_V1,'UserData');
limCenter=str2double(get(S.W_V2_H2_V3_T6_H3_V1_H_edit(1),'string'));
limAngle=str2double(get(S.W_V2_H2_V3_T6_H3_V1_H_edit(2),'string'));
switch h  % Who called?
    case S.W_V2_H2_V3_T6_H3_V1_H1_push(1)
        limCenter=limCenter+1;
    case S.W_V2_H2_V3_T6_H3_V1_H1_push(2)
        limCenter=limCenter-1;
    case S.W_V2_H2_V3_T6_H3_V1_H2_push(1)
        limAngle=limAngle+0.25;
    case S.W_V2_H2_V3_T6_H3_V1_H2_push(2)
        limAngle=limAngle-0.25;
end
...
set(S.W_V2_H2_V3_T6_H3_V1_H_edit(1),'string',limCenter)
set(S.W_V2_H2_V3_T6_H3_V1_H_edit(2),'string',limAngle)

imgProcessing(S,4)
end
function []=W_V2_H2_V3_T6_H3_V2_H_editCall(varargin) % Manage the limit (background)
[h,S]=varargin{[1,3]};  % Get calling handle and structure
set(h,'string',uint8(abs(round(str2double(get(h,'string'))))))

imgProcessing(S,4)
end
function []=W_V2_H2_V3_T6_H3_V2_H_sharedCall(varargin) % Reset the limit background 
S=varargin{3};  % Get structure
[S]=initialPara(S,6);
imgProcessing(S,4)
end
...
function []=W_V2_H2_V3_T7_sharedCall(varargin) % Reset the limit background 
[h,S]=varargin{[1,3]};  % Get calling handle and structure
switch h
    case S.W_V2_H2_V3_T7_G_pop
        P=get(h,'value');
        if P==1
            set(S.W_V2_H2_V3_T7_G_edit,'enable','off')
        else
            set(S.W_V2_H2_V3_T7_G_edit,'enable','on')
        end
    case S.W_V2_H2_V3_T7_G_edit
        set(h,'string',uint8(str2double(get(h,'string'))))
    case S.W_V2_H2_V3_T7_G_push
        set(S.W_V2_H2_V3_T7_G_edit,'string',0)
end
end
...
function []=W_V2_H2_V3_T8_G_sharedCall(varargin) %Manage the binarisation
[h,S]=varargin{[1,3]};  % Get calling handle and structure
switch h
    case {S.W_V2_H2_V3_T8_G_edit(1)}
        set(h,'string',uint8(str2double(get(h,'string'))))
    case {S.W_V2_H2_V3_T8_G_edit(2),S.W_V2_H2_V3_T8_G_edit(3)}
        set(h,'string',max([round(str2double(get(h,'string'))),0]))
    case S.W_V2_H2_V3_T8_G_check(1)
        if get(h,'value')==0
            set(S.W_V2_H2_V3_T8_G_check(2),'value',0)
        end
    case S.W_V2_H2_V3_T8_G_check(2)
        if get(h,'value')==1
            set(S.W_V2_H2_V3_T8_G_check(1),'value',1)
        end    
...
[h,S]=varargin{[1,3]};  % Get calling handle and structure
switch h
    case S.W_V2_H2_V3_T9_G_pop 
        P=get(h,'value');
        if P==1
            set(S.W_V2_H2_V3_T9_G_edit(2),'enable','off')
        else
            set(S.W_V2_H2_V3_T9_G_edit(2),'enable','on')
        end
    case S.W_V2_H2_V3_T9_G_edit(1)
        set(h,'string',uint8(str2double(get(h,'string'))))
    case S.W_V2_H2_V3_T9_G_edit(2)
         set(h,'string',uint8(str2double(get(h,'string'))))
    case S.W_V2_H2_V3_T9_G_edit(3)
        set(h,'string',max([round(str2double(get(h,'string'))),0]))
    case S.W_V2_H2_V3_T9_G_push
        %[S]=initialPara(S,7);     
end
...
function []=W_V2_H2_V3_T10_G_sharedCall(varargin) %Manage the contact angle options
[h,S]=varargin{[1,3]};  % Get calling handle and structure
switch h
    case S.W_V2_H2_V3_T10_G_pop
        switch get(h,'value')
            case 1
                set(S.W_V2_H2_V3_T10_G_edit(1),'visible','off')
                set(S.W_V2_H2_V3_T10_G_edit(2),'visible','off')
                set(S.W_V2_H2_V3_T10_G_edit(3),'visible','off')
                set(S.W_V2_H2_V3_T10_G_edit(4),'visible','off')
            case 2
                set(S.W_V2_H2_V3_T10_G_edit(1),'visible','on')
                set(S.W_V2_H2_V3_T10_G_edit(2),'enable','on')
                set(S.W_V2_H2_V3_T10_G_edit(3),'enable','on')
                set(S.W_V2_H2_V3_T10_G_edit(4),'enable','on')
            case 3
                set(S.W_V2_H2_V3_T10_G_edit(1),'visible','on')
                set(S.W_V2_H2_V3_T10_G_edit(2),'enable','on')
                set(S.W_V2_H2_V3_T10_G_edit(3),'enable','off')
                set(S.W_V2_H2_V3_T10_G_edit(4),'enable','on')
            case 4
                set(S.W_V2_H2_V3_T10_G_edit(1),'visible','on')
                set(S.W_V2_H2_V3_T10_G_edit(2),'enable','on')
                set(S.W_V2_H2_V3_T10_G_edit(3),'enable','on')
                set(S.W_V2_H2_V3_T10_G_edit(4),'enable','off')
            case 5
                set(S.W_V2_H2_V3_T10_G_edit(1),'visible','on')
                set(S.W_V2_H2_V3_T10_G_edit(2),'visible','off')
                set(S.W_V2_H2_V3_T10_G_edit(3),'visible','off')
    ...
    case S.W_V2_H2_V3_T10_G_edit(1)
        ...
        set(h,'string',setVal)
    case S.W_V2_H2_V3_T10_G_edit(2)
        ...
        set(h,'string',setVal)
    case S.W_V2_H2_V3_T10_G_edit(3)
        setVal=str2double(get(h,'string'));
        minVal=0;
        maxVal=1;
        if setVal<minVal
    ...
    case S.W_V2_H2_V3_T10_G_edit(1)
        ...
        set(h,'string',setVal)
    case S.W_V2_H2_V3_T10_G_push
        [S]=initialPara(S,9);
end

I=get(S.W_V1,'UserData');
[I.obs.mainDrop]=getContactAngle(I.obs.mainDrop,I.img.type.S{1},I.img.type.E,str2double(get(S.W_V2_H2_V3_T10_G_edit(1),'string')),...
    get(S.W_V2_H2_V3_T10_G_pop,'val'),str2double(get(S.W_V2_H2_V3_T8_G_edit(1),'string')),...
    str2double(get(S.W_V2_H2_V3_T10_G_edit(2),'string')),str2double(get(S.W_V2_H2_V3_T10_G_edit(3),'string')),str2double(get(S.W_V2_H2_V3_T10_G_edit(4),'string')));
[I.img.features.positions{'contactAngle'}]=getAng2draw(I.obs.mainDrop,I.img.type.B,I.img.features.shape{'contactAngle'}(2));
[I.img.features.pxList{'contactAngle'}]=transfoCoord2PixelList(I.img.type.M,'Line',I.img.features.positions{'contactAngle'},I.img.features.shape{'contactAngle'}(1));
set(S.W_V1,'UserData',I);
imgProcessing(S,0) 
...
function []=W_V2_H2_V3_T11_G_sharedCall(varargin) %Manage the binarisation
[h,S]=varargin{[1,3]};  % Get calling handle and structure
switch h
    case S.W_V2_H2_V3_T11_G_edit
        if get(h,'string')<0 
             set(h,'string',0)
        end
    case S.W_V2_H2_V3_T11_G_check
        if get(h,'value')==0
            set(S.W_V2_H2_V3_T11_G_edit,'Enable','off')
        else
            set(S.W_V2_H2_V3_T11_G_edit,'Enable','on')
        end 
end
...
switch h  % Who called?
    case S.W_V2_H3_V1_V3_H_push(1)
        [ptZone]=getPointerZone(S,0,0);
        I.img.features.positions{'addLines'}{:}=cat(1,I.img.features.positions{'addLines'}{:},ptZone,[NaN,NaN]);
        if I.img.view==1
            [I.img.features.pxList{'addLines'}]=transfoCoord2PixelList(I.img.type.M,'Line',I.img.features.positions{'addLines'},I.img.features.shape{'addLines'});
        else
            [I.img.features.pxList{'addLines'}]=transfoCoord2PixelList(I.img.type.Mu,'Line',I.img.features.positions{'addLines'},I.img.features.shape{'addLines'});
        end
    ...
    case {S.W_V2_H3_V2_T5_V2_H_push(1),S.W_V2_H3_V2_T5_V2_H_push(2)}
        ...
        for k=1:lvlMax
            switch k
                ...
                case 2
                    I.file.tab.full.Setting{dataNum}.filters.median=get(S.W_V2_H2_V3_T2_G_check(2),'value');
                    I.file.tab.full.Setting{dataNum}.filters.sharpening=get(S.W_V2_H2_V3_T2_G_check(3),'value');  
                case 3
                    I.file.tab.full.Setting{dataNum}.backgroundNbr=str2double(get(S.W_V2_H2_V3_T4_G_edit(1),'string'));
                case 4
                    if get(S.W_V2_H2_V3_T6_H2_V_radio(1),'value')==1
                        I.file.tab.full.Setting{dataNum}.surface.type=get(S.W_V2_H2_V3_T6_H2_V_radio(1),'String');
                        I.file.tab.full.Setting{dataNum}.surface.val=str2double(get(S.W_V2_H2_V3_T6_H3_V1_H_edit(:),'String'));
                    else
                        I.file.tab.full.Setting{dataNum}.surface.type=get(S.W_V2_H2_V3_T6_H2_V_radio(2),'String');
                        I.file.tab.full.Setting{dataNum}.surface.val=str2double(get(S.W_V2_H2_V3_T6_H3_V2_H_edit,'String'));
                    end
                case 5
                    I.file.tab.full.Setting{dataNum}.binarisation.threshold=str2double(get(S.W_V2_H2_V3_T8_G_edit(1),'String'));
                    I.file.tab.full.Setting{dataNum}.binarisation.minDetection=str2double(get(S.W_V2_H2_V3_T8_G_edit(2),'String'));
                    I.file.tab.full.Setting{dataNum}.binarisation.surfCorrection=str2double(get(S.W_V2_H2_V3_T8_G_edit(3),'String'));
                    I.file.tab.full.Setting{dataNum}.binarisation.fill(1)=get(S.W_V2_H2_V3_T8_G_check(1),'value');
                    I.file.tab.full.Setting{dataNum}.binarisation.fill(2)=get(S.W_V2_H2_V3_T8_G_check(2),'value');
                case 6
                    I.file.tab.full.Setting{dataNum}.trackingMod=I.track.mod;
                ...
                case 7
                    P=get(S.W_V2_H2_V3_T10_G_pop,'String');
                    I.file.tab.full.Setting{dataNum}.contactAngle.method=P{get(S.W_V2_H2_V3_T10_G_pop,'value')};
                    I.file.tab.full.Setting{dataNum}.contactAngle.zone=str2double(get(S.W_V2_H2_V3_T10_G_edit(1),'String'));
                    I.file.tab.full.Setting{dataNum}.contactAngle.offset=str2double(get(S.W_V2_H2_V3_T10_G_edit(2),'String'));
                    I.file.tab.full.Setting{dataNum}.contactAngle.smoothVal=str2double(get(S.W_V2_H2_V3_T10_G_edit(3),'String'));
                    I.file.tab.full.Setting{dataNum}.contactAngle.Weight=str2double(get(S.W_V2_H2_V3_T10_G_edit(4),'String'));
                case 8
                    I.file.tab.full.Setting{dataNum}.trackingMod=I.track.mod;
                case 9
                    I.file.tab.full.Output{dataNum}.dropClass=I.class.drops.tab;
...
if I.img.display.type==1
    ...
    % ID
    if strcmp(get(get(S.um(6),'Parent'),'UserData'),'Active')
        m=I.img.type.L{imgNbr}(ptY,ptX);
        if m>0
            ID=I.track.new{imgNbr}(m).dropID;
            if isnan(ID)
                set(S.um(6),'label','Drop ID: No ID')
            else
                set(S.um(6),'label',['Drop ID: ' num2str(ID)])
            end
        else
            set(S.um(6),'label','Drop ID: No drop selected')
        end
    end
    
    %Class
    if strcmp(get(get(S.um(8),'Parent'),'UserData'),'Active')
        m=I.img.type.L{imgNbr}(ptY,ptX);
        if m>0
            ID=I.track.new{imgNbr}(m).dropID;
            set(S.um(8),'label',['Class:' I.class.drops.text{I.class.drops.tab{ID,I.class.drops.tab.Properties.VariableNames}==1}])
        else
            set(S.um(8),'label','Class: No drop selected')
        end
    end
    
elseif I.img.display.type==3
    set(S.um(12),'label','Drop ID: No drop selected')
    set(S.um(14),'label','Drop type:-' )
    set(S.um(16),'label','Volume method:-')
    set(S.um(18),'label','Relative volume:-')
    if sum(I.img.type.P{imgNbr}(ptY,ptX))>0
        [pos,subPos]=getPinningPosition(S,imgNbr,ptX);
        set(S.um(12),'label',['Drop ID: ' num2str(I.class.pinning.tab.PinnedDrops{imgNbr}(pos))])
        if ~(subPos==0)
            set(S.um(14),'label',['Drop type: ' get(S.ums(20+I.class.pinning.tab.Type{imgNbr}{pos}(subPos)),'label')])
            set(S.um(16),'label',['Volume method: ' get(S.ums(23+I.class.pinning.tab.volMethod{imgNbr}{pos}(subPos)),'label')])
            set(S.um(18),'label',['Relative volume: ' num2str(I.class.pinning.tab.RelVol{imgNbr}{pos}(subPos))])
        end
    end
end
...
%set(S.um(4),'Callback',{@umControl_call,S})
function []=umControl_call(varargin) % Action righ click: Crop image
S=varargin{3}; % Get the structure
[ptZone]=getPointerZone(S,1,1);
I=get(S.W_V1,'UserData');
if I.img.view ==1
    set(S.W_V2_H2_V3_T2_G_edit(1),'string',ptZone(1,1))
    set(S.W_V2_H2_V3_T2_G_edit(2),'string',ptZone(2,1))
    set(S.W_V2_H2_V3_T2_G_edit(3),'string',ptZone(1,2))
    set(S.W_V2_H2_V3_T2_G_edit(4),'string',ptZone(2,2))
    set(S.W_V2_H2_V3_T2_G_check(1),'value',1)
else
    set(S.W_V2_H2_V3_T3_G_edit(1),'string',ptZone(1,1))
    set(S.W_V2_H2_V3_T3_G_edit(2),'string',ptZone(2,1))
    set(S.W_V2_H2_V3_T3_G_edit(3),'string',ptZone(1,2))
    set(S.W_V2_H2_V3_T3_G_edit(4),'string',ptZone(2,2))
    set(S.W_V2_H2_V3_T3_G_check(1),'value',1)
end
imgProcessing(S,2)
end
...
if str2double(get(S.W_V2_H2_V3_T6_H3_V1_H_edit(2),'string'))==0
    [ptLast]=getPointerLastClic(S);
%     m=tand(str2double(get(S.W_V2_H2_V3_T6_H3_V1_H_edit(2),'string')));
%     y=ptLast(2)+m*(ptLast(1)-mean([1,size(I.img.type.BG,2)]));
    set(S.W_V2_H2_V3_T6_H3_V1_H_edit(1),'string',ptLast(2))
else
    onCrop=1;
...
for i=1:length(steps2ini)
    switch steps2ini(i)
        ...
        case 5 %Background            
            set(S.W_V2_H2_V3_T4_G_edit(1),'string',0)
        case 6 %Limit           
            set(S.W_V2_H2_V3_T6_H2_V_radio(1),'Value',1)
            set(S.W_V2_H2_V3_T6_H3_V1_H_edit(1),'string',0)
            set(S.W_V2_H2_V3_T6_H3_V1_H_edit(2),'string',0)
            set(S.W_V2_H2_V3_T6_H3_V2_H_edit,'string',0)
            
        case 7 %Binarisation
            set(S.W_V2_H2_V3_T8_G_edit(1),'string',0)
            set(S.W_V2_H2_V3_T8_G_edit(2),'string',5)
            set(S.W_V2_H2_V3_T8_G_edit(3),'string',0)     
            set(S.W_V2_H2_V3_T8_G_check(1),'value',1)
            set(S.W_V2_H2_V3_T8_G_check(2),'value',0)
            set(S.W_V2_H2_V3_T9_G_edit(1),'string',0)
            set(S.W_V2_H2_V3_T9_G_edit(2),'string',255)
            set(S.W_V2_H2_V3_T9_G_edit(3),'string',5)
        case 8 %Tracking
            I.track.new=[];
            I.track.new2=[];
            I.track.drops=[];
        ...
        case 9 %Contact angle
            set(S.W_V2_H2_V3_T10_G_edit(1),'string',10)
            set(S.W_V2_H2_V3_T10_G_edit(2),'string',0)
            set(S.W_V2_H2_V3_T10_G_edit(3),'string',0.7)
            set(S.W_V2_H2_V3_T10_G_edit(4),'string',2)
...
%                         if str2double(get(S.W_V2_H2_V3_T2_G_edit,'string'))==0
%                             [percLimit] = getOptimisedPerc(I.img.type.M);
%                             set(S.W_V2_H2_V3_T2_G_edit,'string',percLimit)
%                         end
                        xy=[str2double(get(S.W_V2_H2_V3_T2_G_edit(1),'string')),str2double(get(S.W_V2_H2_V3_T2_G_edit(2),'string')),str2double(get(S.W_V2_H2_V3_T2_G_edit(3),'string')),str2double(get(S.W_V2_H2_V3_T2_G_edit(4),'string'))];
                        [I.img.type.M]=getImgsCorrected(I.img.type.M,xy);
                    end
                    if get(S.W_V2_H2_V3_T3_G_check(1),'value')==1
                        %if str2double(get(S.W_V2_H2_V3_T3_G_edit,'string'))==0
%                             [percLimit] = getOptimisedPerc(I.img.type.Mu);
%                             set(S.W_V2_H2_V3_T3_G_edit,'string',percLimit)
                        %end
                        xy=[str2double(get(S.W_V2_H2_V3_T3_G_edit(1),'string')),str2double(get(S.W_V2_H2_V3_T3_G_edit(2),'string')),str2double(get(S.W_V2_H2_V3_T3_G_edit(3),'string')),str2double(get(S.W_V2_H2_V3_T3_G_edit(4),'string'))];
                        [I.img.type.Mu]=getImgsCorrected(I.img.type.Mu,xy);
                    end
                    ...
                    if get(S.W_V2_H2_V3_T3_G_check(3),'value')==1
                ...
                case 3 % Background substraction
                    if str2double(get(S.W_V2_H2_V3_T4_G_edit(1),'string'))==0
                        [n_base]=getNbrBackground(I.img.type.M);
                        set(S.W_V2_H2_V3_T4_G_edit(1),'string',n_base);
                        set(S.W_V2_H2_V3_T5_G_edit(1),'string',n_base);
                    end
                   
                    [I.img.type.BG{1}]=getImgBackground(I.img.type.M,str2double(get(S.W_V2_H2_V3_T4_G_edit(1),'string')),str2double(get(S.W_V2_H2_V3_T4_G_edit(2),'string')));
                    [I.img.type.E]=getImgsEnhanced(I.img.type.M,I.img.type.BG{1});
                    if get(S.W_V2_H1_V2_V5_H_pop,'value')==2
                        [I.img.type.BGu{1}]=getImgBackground(I.img.type.Mu,str2double(get(S.W_V2_H2_V3_T5_G_edit(1),'string')),str2double(get(S.W_V2_H2_V3_T5_G_edit(2),'string')));
                        [I.img.type.Eu]=getImgsEnhanced(I.img.type.Mu,I.img.type.BGu{1});
                    end
                case 4 % Surface limit
                    %   % Line
                    if get(S.W_V2_H2_V3_T6_H2_V_radio(1),'Value')==1
                        if str2double(get(S.W_V2_H2_V3_T6_H3_V1_H_edit(1),'string'))==0
                            ...
                            set(S.W_V2_H2_V3_T6_H3_V1_H_edit(1),'string',yLim)
                        end
                        [I.img.type.S{1}]=getSurfMaskFromLine(I.img.type.BG{1},[str2double(get(S.W_V2_H2_V3_T6_H3_V1_H_edit(1),'string')),str2double(get(S.W_V2_H2_V3_T6_H3_V1_H_edit(2),'string'))]);
                    %   % Background
                    else 
                        greyLim=str2double(get(S.W_V2_H2_V3_T6_H3_V2_H_edit,'string'));
                        if greyLim==0
                            greyLim=uint8(graythresh(I.img.type.BG{1})*255); %Limite: 1 to 255
                        end
                        [I.img.type.S{1},greyLim]=getSurfMaskFromBackground(I.img.type.BG{1},greyLim);
                        set(S.W_V2_H2_V3_T6_H3_V2_H_edit,'string',greyLim);
                    end
                    [I.img.features.pxList{'limitSurface'}]=getSurfLimit(I.img.type.S{1},1); %I.img.type.SL
                    if get(S.W_V2_H1_V2_V5_H_pop,'value')==2
                        if get(S.W_V2_H2_V3_T7_G_pop,'value')==1
                            I.img.type.Su{1}=true(size(I.img.type.BGu{1}));
                        else
                            greyThreshold=str2double(get(S.W_V2_H2_V3_T7_G_edit,'string'));
                            [I.img.type.Su{1},greyThreshold]=getUnderneathFocus(I.img.type.BGu{1},greyThreshold);
                            set(S.W_V2_H2_V3_T7_G_edit,'string',greyThreshold)
                        end
                    end
                case 5 % Binarisation: + Binary
                    if str2double(get(S.W_V2_H2_V3_T8_G_edit(1),'string'))==0
                        [greyThreshold]=getImgsBinarisedThreshold(I.img.type.E,I.img.type.S{1});
                        set(S.W_V2_H2_V3_T8_G_edit(1),'string',greyThreshold)
                    end
                    [I.img.type.B]=getImgsBinarised(I.img.type.E,I.img.type.S{1},str2double(get(S.W_V2_H2_V3_T8_G_edit(1),'string')));
                    [I.img.type.B]=getImgsBinFiltered(I.img.type.B,I.img.type.S{1},str2double(get(S.W_V2_H2_V3_T8_G_edit(3),'string')),str2double(get(S.W_V2_H2_V3_T8_G_edit(2),'string')));
                    [I.img.type.B]=getImgsBinFilled(I.img.type.B,I.img.type.S{1},get(S.W_V2_H2_V3_T8_G_check(1),'value'),get(S.W_V2_H2_V3_T8_G_check(2),'value'));
                    [I.track.ori,I.img.type.L]=getObjProp(I.img.type.B,I.img.type.S{1});              
                    if get(S.W_V2_H1_V2_V5_H_pop,'value')==2
                        if str2double(get(S.W_V2_H2_V3_T9_G_edit(1),'string'))==0
                            [darkGreyThreshold]=getUnderImgsBinarisedDarkThreshold(I.img.type.Eu,I.img.type.Su{1});
                            set(S.W_V2_H2_V3_T9_G_edit(1),'string',darkGreyThreshold)
                        end
                        if str2double(get(S.W_V2_H2_V3_T9_G_edit(2),'string'))==255
                            [brightGreyThreshold]=getUnderImgsBinarisedBrightThreshold(I.img.type.Eu,I.img.type.Su{1},str2double(get(S.W_V2_H2_V3_T9_G_edit(1),'string')));
                            set(S.W_V2_H2_V3_T9_G_edit(2),'string',brightGreyThreshold)
                        end
                        [I.img.type.Bu]=getUnderImgsBinarised(I.img.type.Eu,I.img.type.Su{1},get(S.W_V2_H2_V3_T9_G_pop,'value'),str2double(get(S.W_V2_H2_V3_T9_G_edit(1),'string')),str2double(get(S.W_V2_H2_V3_T9_G_edit(2),'string')));
                        [I.img.type.Bu]=getImgsBinFiltered(I.img.type.Bu,I.img.type.Su{1},0,str2double(get(S.W_V2_H2_V3_T9_G_edit(3),'string')));
                ...
                case 7 % Main drop info
                    ...
                    [I.img.features.pxList{'contactAngle'}]=transfoCoord2PixelList(I.img.type.M,'Line',I.img.features.positions{'contactAngle'},I.img.features.shape{'contactAngle'}(1));    
                    if get(S.W_V2_H1_V2_V5_H_pop,'value')==2
                        [I.obs.mainDrop,I.img.features.pxList{'contactLine'},I.img.features.positions{'underAxes'}]=getMainDropUnderObs(I.obs.mainDrop,I.img.type.Eu,I.img.type.Bu,get(S.W_V2_H2_V3_T11_G_check,'value'),str2double(get(S.W_V2_H2_V3_T11_G_edit,'string')));
                        [I.img.features.pxList{'underAxes'}]=transfoCoord2PixelList(I.img.type.Mu,'Line',I.img.features.positions{'underAxes'},I.img.features.shape{'underAxes'});
                    end
...
switch I.img.display.type
    case 1
        if b==1
            [S]=managePointerMenue(S,'Start');
        elseif b==2
            [S]=managePointerMenue(S,'Filters');
        elseif b<6
            [S]=managePointerMenue(S,'ImageMod');
        elseif b<9
...
if get(S.W_V2_H2_V1_V_V1_H_pop,'Value')>1
    if I.img.view==1
        ...
        if I.img.display.type==1
            if get(S.W_V2_H2_V1_V_V2_T1_H_toggle(6),'Value')==1
                [I.img.type.img2show]=drawFeaturesOnRGB(I.img.type.img2show,I.img.features.pxList{'contactLine'},I.img.features.color{'contactLine'});
                [I.img.type.img2show]=drawFeaturesOnRGB(I.img.type.img2show,I.img.features.pxList{'underAxes'},I.img.features.color{'underAxes'});
            end
        end
    end
    %Additional lines
...
if str2double(get(S.W_V2_H2_V2_H_edit,'string'))>2
    lm=str2double(get(S.W_V2_H2_V3_T6_H3_V1_H_edit(1),'string'))-(str2double(get(S.W_V2_H2_V3_T1_G_edit(3),'string'))-I.modi.crop.posi(3));
    lmMax=(str2double(get(S.W_V2_H2_V3_T1_G_edit(4),'string'))-str2double(get(S.W_V2_H2_V3_T1_G_edit(3),'string')))+1;
    if lm>lmMax
        lm=lmMax;
    end
    set(S.W_V2_H2_V3_T6_H3_V1_H_edit(1),'string',lm)
end
...
function [ptZone]=getPointerZone(S,onCrop,onSorted)
